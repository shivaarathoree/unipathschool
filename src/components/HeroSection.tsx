...
export default function HeroSection() {
    return (
        <section className="relative min-h-screen pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white flex items-center">
            ...
            <motion.div 
                ...
                className="absolute top-0 left-1/4 w-[40rem] h-[40rem] bg-gradient-to-tr from-primary/10 to-orange-400/5 blur-[100px] rounded-full mix-blend-multiply pointer-events-none z-0"
            />
            <motion.div 
                animate={{ 
                    rotate: -360,
                ...
                className="absolute bottom-0 right-1/4 w-[45rem] h-[45rem] bg-gradient-to-bl from-orange-500/5 to-primary/15 blur-[120px] rounded-full mix-blend-multiply pointer-events-none z-0"
            />
            ...
            <div className="max-w-7xl w-full mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                <div className="relative z-10 flex flex-col items-start">
                    <motion.div 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-slate-800 shadow-[0_0_1rem_rgba(194,65,12,0.1)] mb-8"
                    >
                    ...
                    <motion.h1 
                        ...
                        className="text-6xl lg:text-[5.5rem] font-medium tracking-tighter text-slate-900 leading-[1.05] mb-8 font-heading"
                    >
                        Engineering <br />
                    ...
                    <motion.p 
                        ...
                        className="text-lg lg:text-xl font-light text-slate-600 mb-10 max-w-lg leading-relaxed"
                    >
                        UNIPATH SCHOOL engineers personalized career paths, skill-gap analysis, and AI-driven interview preparation for the next generation of professionals.
                    </motion.p>
                    ...
                    >
                        <Link href="/career-discovery" className="relative overflow-hidden flex items-center justify-center gap-2 px-10 py-4 text-sm font-medium text-white bg-slate-900 rounded-full shadow-lg hover:shadow-primary/20 transition-all duration-300 group flex-1 sm:flex-none">
                        ...
                        <button className="relative flex items-center justify-center gap-2 px-10 py-4 text-sm font-medium text-slate-700 bg-white/80 backdrop-blur-md border border-slate-200 hover:border-primary/30 hover:bg-slate-50 rounded-full transition-all duration-300 flex-1 sm:flex-none group">
                ...
                <div className="relative w-full h-[32rem] flex items-center justify-center lg:justify-end perspective-[1000px]">
                    <motion.div 
