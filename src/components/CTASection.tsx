        ...
        <section className="py-32 bg-slate-950 text-white relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col items-center justify-center text-center">
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 text-[10px] font-bold text-primary tracking-[0.2em] uppercase mb-10"
                >
                    Ready to begin?
                </motion.div>
                ...
                <motion.h2 
                    ...
                    className="text-5xl md:text-7xl font-medium font-heading tracking-tighter text-white mb-16 leading-[1.1]"
                >
                ...
                >
                    <Link href="/login" className="relative w-full py-5 px-10 rounded-full bg-white text-slate-900 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-primary hover:text-white transition-all duration-500 text-center shadow-xl group">
                        Become a Member
                    ...
                    <Link href="/career-discovery" className="relative w-full py-5 px-10 rounded-full border border-white/20 text-white text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-white/10 transition-all duration-500 text-center">
                        Start for Free
                    </Link>
                </motion.div>
            </div>
