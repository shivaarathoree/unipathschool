...
export default function FaangRoadmapSection() {
    ...
    return (
        <section className="py-32 px-6 relative bg-white overflow-hidden border-b border-slate-100">
            {/* Background Accent */}
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                >
                    ...
                    <span className="text-slate-300 font-medium text-[10px] tracking-[0.2em] uppercase">
                ...
                <motion.h2 
                    ...
                    className="text-4xl md:text-6xl font-semibold font-heading text-slate-900 mb-8 tracking-tighter"
                >
                ...
                <motion.p 
                    ...
                    className="text-lg md:text-xl text-slate-500 mb-12 max-w-2xl mx-auto font-light leading-relaxed"
                >
                    ...
                    <form onSubmit={handleGenerate} className="flex flex-col sm:flex-row items-center gap-4 p-2 bg-slate-50 border border-slate-200 rounded-[2rem] shadow-sm focus-within:border-primary/30 transition-all duration-300">
                        <div className="relative flex-grow w-full">
                            <IconifyIcon
                                ...
                                className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 text-xl"
                            />
                            <input
                                type="text"
                                value={handle}
