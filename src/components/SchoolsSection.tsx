...
export default function SchoolsSection() {
    return (
        <section id="schools" className="py-32 bg-white relative overflow-hidden border-b border-slate-100">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        className="flex flex-col group p-12 bg-slate-50 border border-slate-200 rounded-[3rem] hover:border-primary/30 transition-all duration-500 relative overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            <div className="mb-10">
                                <span className="inline-block px-4 py-1.5 text-[10px] font-semibold text-primary border border-primary/20 rounded-full bg-primary/5 tracking-[0.2em] uppercase">
                                    B2B Platform
                                </span>
                            </div>
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="flex flex-col p-12 bg-slate-900 border border-slate-800 rounded-[3rem] relative overflow-hidden group"
                    >
