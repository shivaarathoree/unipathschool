            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        className="col-span-12 md:col-span-6 bg-slate-50 border border-slate-200 rounded-[3rem] p-10 lg:p-14 flex flex-col justify-between overflow-hidden relative group"
                    >
                        <div className="relative z-10">
                            ...
                            <h3 className="text-3xl lg:text-4xl text-slate-900 font-medium tracking-tighter mb-6 font-heading leading-tight">
                                Precision <span className="text-primary">Skill-Gap</span> Analysis.
                            </h3>
                            <p className="text-base text-slate-500 leading-relaxed font-light mb-12 max-w-md">
                        ...
                        {/* Abstract UI Card */}
                        <div className="bg-white border border-slate-200 rounded-3xl p-8 relative overflow-hidden shadow-sm group-hover:shadow-xl transition-all duration-500 group-hover:-translate-y-2">
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="col-span-12 md:col-span-6 bg-slate-900 border border-slate-800 rounded-[3rem] p-10 lg:p-14 flex flex-col justify-between relative overflow-hidden group"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-3xl lg:text-4xl text-white font-medium tracking-tighter mb-6 font-heading leading-tight">
                                AI Interviews that <span className="text-primary">Feel Real.</span>
                            </h3>
                            <p className="text-base text-slate-400 leading-relaxed font-light mb-12 max-w-md">
                        ...
                        <div className="space-y-4 relative z-10">
                            {[
                                ...
                                >
                                    ...
                                    <span className="text-primary font-bold tracking-widest">{item.score}</span>
                                </motion.div>
                            ))}
                        </div>
                    </motion.div>
