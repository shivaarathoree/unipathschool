...
export default function OnboardingPage() {
    ...
    useEffect(() => {
        if (!loading && profile && !isSubmitting) {
            router.push("/dashboard");
        }
    }, [loading, profile, isSubmitting, router]);
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-12 relative z-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-heading font-medium text-slate-900 tracking-tighter">Identity Setup</h1>
                                <p className="text-sm text-slate-500 font-light">Architect your professional profile.</p>
                            </div>
                        </div>
                            ...
                            {step < 4 ? (
                                ...
                                >
                                    {isSubmitting ? (
                                        ...
                                        <>Finalize Profile <IconifyIcon icon="solar:check-read-linear" className="text-lg group-hover:scale-110 transition-transform" /></>
                                    )}
                                </button>
                            )}
                        </div>
