                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                                    ...
                                    {hasQuestions ? (
                                        <RazorpayButton
                                            ...
                                            className="bg-primary hover:bg-primary-dark text-white text-[10px] px-6 py-3 rounded-full font-bold uppercase tracking-widest transition-all flex items-center gap-2"
                                        />
                                    ) : (
