...
export default function AIInterviewDashboard() {
    ...
    return (
        <PaymentGate
            ...
            featureDescription="Practice real-world interview scenarios powered by AI. Get scored feedback and sharpen your skills before the real thing."
            amount={499}
            storageKey="unipath_ai_interview_paid"
        >
            {dashboard}
        </PaymentGate>
    );
