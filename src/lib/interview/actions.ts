...
export async function getInterviewById(id: string): Promise<InterviewRecord | null> {
    try {
        ...
        console.error("Database connection failed in getInterviewById:", e);
        return null;
    }
}
...
export async function getFeedbackByInterviewId(
    ...
    try {
        ...
        console.error("Database connection failed in getFeedbackByInterviewId:", e);
        return null;
    }
}
...
export async function getLatestInterviews(
    ...
    try {
        ...
        console.error("Database connection failed in getLatestInterviews:", e);
        return [];
    }
}
...
export async function getInterviewsByUserId(
    ...
    try {
        ...
        console.error("Database connection failed in getInterviewsByUserId:", e);
        return [];
    }
}
