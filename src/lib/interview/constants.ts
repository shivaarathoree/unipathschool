...
export const techMappings: Record<string, string> = {
    ...
    nestjs: "nestjs", graphql: "graphql", "graph ql": "graphql",
    apollo: "apollo", webpack: "webpack", babel: "babel",
    npm: "npm", yarn: "yarn", git: "git", github: "github",
    gitlab: "gitlab", bitbucket: "bitbucket", figma: "figma",
    prisma: "prisma", redux: "redux", redis: "redis",
    selenium: "selenium", cypress: "cypress", jest: "jest",
    mocha: "mocha", chai: "chai",
    "nuxt.js": "nuxt", nuxtjs: "nuxt", nuxt: "nuxt",
    strapi: "strapi", wordpress: "wordpress",
    netlify: "netlify", vercel: "vercel",
    python: "python", java: "java", "c++": "cplusplus",
